...
;(function($) {
    ...
    $.Zebra_DatePicker = function(element, options) {
        ...
        plugin.show = function() {
            ...
            if (!plugin.settings.always_visible) {
                ...
                var
					...
					left = undefined !== icon ? icon.offset().left + icon.outerWidth(true) : $element.offset().left,
                    //top = (undefined !== icon ? icon.offset().top : $element.offset().top) - datepicker_height + plugin.settings.offset[1],
					top = undefined !== icon ? icon.offset().top : $element.offset().top + $element.outerHeight(true),
        ...
        var generate_daypicker = function() {
            ...
            manage_header(selected_year + '年 ' + plugin.settings.months[selected_month]);
        ...
        plugin.getCurrentDate = function(){  
         return new Date( current_system_year,current_system_month, current_system_day); };
         
        plugin.getFirstableDate=function(){
        	return new Date(first_selectable_year,first_selectable_month,  first_selectable_day);};
    ...
    $.fn.Zebra_DatePicker = function(options,fnret) {
        ...
        return this.each(function() {
            ...
            if(typeof(fnret)=='function'){ 
            	fnret( plugin.getCurrentDate(), plugin.getFirstableDate() );
            }
